...
export function roomLeaveConfirmationMessage(phase: RoomPhase, gameType?: GameType): string {
  switch (phase) {
    ...
    case "PLAYING":
      ...
      if (gameType === "AVALON") return "방을 나가면 이번 아발론 판이 취소됩니다. 잠시 끊긴 연결은 재접속할 수 있습니다. 방을 나가시겠습니까?";
      ...
      if (gameType === "TERRAFORMING_MARS") return "나가면 이번 테라포밍 마스 게임이 취소됩니다. 잠시 자리를 비우려면 창을 닫고 재접속할 수 있습니다. 방에서 나가시겠습니까?";
