    ...
    try {
      ...
      return {
        ...
        gameType: gameType === "HANGUL_TILE" || gameType === "NUMBER_TILE" ||
          gameType === "GEM_CARD" || gameType === "CITY_ROLE" || gameType === "DRAW_RELAY" || gameType === "SNEAKY_LUNCH" || gameType === "WOLF_NIGHT" || gameType === "LIAR_GAME" || gameType === "SPYFALL" || gameType === "AVALON" || gameType === "WORD_DUET" || gameType === "TRAIN" || gameType === "CENTURY" || gameType === "SPIRIT_ISLAND" || gameType === "SPACE_CREW" || gameType === "ARK_NOVA" || gameType === "JAIPUR" || gameType === "LOVE_LETTER" || gameType === "GURYONGTU" || gameType === "GREAT_KINGDOM" || gameType === "AZUL" || gameType === "VEGAS" || gameType === "CARCASSONNE" || gameType === "BURGUNDY" || gameType === "CLUE" || gameType === "TERRORSCAPE" || gameType === "PANDEMIC" || gameType === "PERCH" || gameType === "HARMONIES" || gameType === "PATCHWORK" || gameType === "ARNAK" || gameType === "TERRAFORMING_MARS" || gameType === "SEVEN_WONDERS_DUEL" || gameType === "SABOTEUR" || gameType === "LOST_CITIES" || gameType === "SPLENDOR" || gameType === "HALLI_GALLI" || gameType === "ISLAND_SETTLERS" ? gameType : null,
      };
    } catch {
      return null;
    }
