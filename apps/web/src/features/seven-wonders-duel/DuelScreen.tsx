...
function Table(props: Props & {
 ...
 <div className="du-status" role="status"><span className={mine ? 'active' : ''}/><strong>{g.phase === 'FINISHED' ? '게임 종료' : mine ? '당신의 선택' : '상대의 선택'}</strong><span>{g.decision?.label ?? '결과를 확인하세요'}</span>{mine && (g.stage === 'RESOLVING' || g.stage === 'NEXT_AGE') && <a href="#du-next-choice">선택 목록으로 ↓</a>}</div>
