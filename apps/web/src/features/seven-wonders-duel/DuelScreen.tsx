...
import { DUEL_DEFAULT_SETTINGS, DUEL_CARDS, DUEL_WONDERS, DUEL_GODS, DUEL_DECREES, PROTOCOL_VERSION, type DuelProjection, type DuelClientCommand, type DuelOption } from '@hangul-rummikub/shared';
...
function Table(props: Props & {
    ...
    const [inspect, setInspect] = useState<{
        id: string | null;
        source: string;
    } | null>(null), [option, setOption] = useState<string | null>(null), [reference, setReference] = useState(false), [ledger, setLedger] = useState(false), [militaryOpen, setMilitaryOpen] = useState(false);
