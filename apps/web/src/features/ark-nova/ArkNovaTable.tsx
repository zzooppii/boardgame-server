...
export function ArkNovaTable({state:s,disabled,onCommand:send,onCue}:Props) {
  ...
  const placementHint=s.activeEffect?.kind==='FREE_BUILD'?arkFreeBuildPlacementHint(s,placement):placement&&(buildMode||s.activeBuild)?arkBuildPlacementHint(s,placement):null;
