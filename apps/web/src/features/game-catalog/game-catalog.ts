...
export const GAME_CATALOG = Object.freeze([
  ...
  Object.freeze({ gameType: "GREAT_KINGDOM", displayName: "그레이트 킹덤", description: "성을 세워 영토를 넓히고 상대의 성을 포위하세요. 친구 또는 초급·중급·고급 AI와 겨루는 전략 게임입니다." }),
  ...
  Object.freeze({ gameType: "AVALON", displayName: "아발론", description: "원탁에 숨은 악을 찾아라. 5~10명이 비밀 역할과 원정 투표로 겨루는 중세 판타지 추리 게임." }),
  ...
  Object.freeze({ gameType: "TERRAFORMING_MARS", displayName: "테라포밍 마스", description: "붉은 행성에 바다와 숲, 도시를 만드는 2–5인 기업 경쟁. 기본 지도 · 기업시대·프렐류드 선택." }),
