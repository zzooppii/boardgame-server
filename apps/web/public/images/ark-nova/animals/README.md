...
2026-09-15 audit: all 128 images were reviewed again against card names. Standalone `516-v2.webp` and `518-v2.webp` replace the northern cassowary and lesser bird-of-paradise. Atlas crops now use measured bounds with a 2px inset instead of uniform 424% zoom. Exact replacement prompts: `revision-v2-prompts.json`. See `docs/ARK_NOVA_MEDIA_AUDIT.md` for the review and its limits.
