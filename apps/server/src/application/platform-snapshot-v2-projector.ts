...
export class PlatformSnapshotV2Projector {
  ...
  async project(
    ...
    if(input.room.gameType === "TERRAFORMING_MARS") return v.parse(PlatformSnapshotV2Schema, {...base,room:{...base.room,phase:input.room.phase},game:projectMars(input.room.game,input.selfPlayerId)});
