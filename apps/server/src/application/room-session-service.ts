  ...
  async #createRoom(
    ...
    for (
      ...
      const roomCandidate: RoomWriteCandidate =
        (gameType === "ARK_NOVA" || gameType === "SPIRIT_ISLAND" || gameType === "TERRORSCAPE" || gameType === "PANDEMIC" || gameType === "PERCH" || gameType === "HARMONIES" || gameType === "PATCHWORK" || gameType === "SEVEN_WONDERS_DUEL" || gameType === "AVALON")
