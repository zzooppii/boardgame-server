...
export function projectDuel(game: DuelStoredGame | null, viewer: PlayerId): DuelProjection | null {
    ...
    return s.phase === 'PLAYING' ? parse(DuelPlayingProjectionSchema, { ...base, phase: 'PLAYING', turnId: s.transitionId, deadlineAt: s.deadlineAt }) : parse(DuelFinishedProjectionSchema, { ...base, phase: 'FINISHED', result: s.result });
}
