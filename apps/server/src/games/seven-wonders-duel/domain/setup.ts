...
export function createDuelGame(input: {
    ...
    const s = parseDuelState({ gameId: input.gameId, revision: 0, rulesVersion: DUEL_RULES_VERSION, startedAt: input.now, finishedAt: null, phase: 'PLAYING', transitionId: input.turnId, settings,
