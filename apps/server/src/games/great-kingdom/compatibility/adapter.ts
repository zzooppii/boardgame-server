...
export type GreatKingdomLifecycle=Readonly<{lifecycle:'RUNNING';gameId:GameId;gameRevision:GameRevision;activeTurn:Readonly<{turnId:TurnId;deadlineAt:ServerTime}>|null}>|Readonly<{lifecycle:'FINISHED';gameId:GameId;finishedAt:ServerTime}>;
