...
import type { ArnakStoredGame } from "../games/arnak/compatibility/adapter.js";
import type { MarsStoredGame } from "../games/mars/compatibility/adapter.js";
import type { DuelStoredGame } from "../games/seven-wonders-duel/compatibility/adapter.js";
...
export type HarmoniesRoomRecord = RoomRecordBase & Readonly<{ gameType: "HARMONIES"; settings?: import("@hangul-rummikub/shared").HarmoniesSettings; game: HarmoniesStoredGame | null; departedPlayerIds?: readonly PlayerId[] }>;
export type PatchworkRoomRecord = RoomRecordBase & Readonly<{ gameType: "PATCHWORK"; settings?: import("@hangul-rummikub/shared").PatchworkSettings; game: PatchworkStoredGame | null; departedPlayerIds?: readonly PlayerId[] }>;
export type ArnakRoomRecord = RoomRecordBase & Readonly<{ gameType: "ARNAK"; game: ArnakStoredGame | null; departedPlayerIds?: readonly PlayerId[] }>;
export type MarsRoomRecord = RoomRecordBase & Readonly<{ gameType: "TERRAFORMING_MARS"; settings?: Readonly<{corporateEra:boolean;prelude?:boolean}>; game: MarsStoredGame | null; departedPlayerIds?: readonly PlayerId[] }>;
export type DuelRoomRecord = RoomRecordBase & Readonly<{ gameType: "SEVEN_WONDERS_DUEL"; game: DuelStoredGame | null; settings?: import("@hangul-rummikub/shared").DuelSettings; departedPlayerIds?: readonly PlayerId[] }>;
