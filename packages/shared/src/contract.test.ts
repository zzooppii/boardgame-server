...
test("GameType runtime contract는 정확히 35개의 구현된 게임을 지원한다", () => {
  assert.deepEqual(SUPPORTED_GAME_TYPES, ["HANGUL_TILE", "NUMBER_TILE", "GEM_CARD", "CITY_ROLE", "DRAW_RELAY", "SNEAKY_LUNCH", "WOLF_NIGHT", "HALLI_GALLI", "ISLAND_SETTLERS", "SPLENDOR", "JAIPUR", "ARK_NOVA", "SPACE_CREW", "TRAIN", "CENTURY", "SPIRIT_ISLAND", "LOVE_LETTER", "GURYONGTU", "GREAT_KINGDOM", "WORD_DUET", "LOST_CITIES", "SABOTEUR", "LIAR_GAME", "SPYFALL", "AVALON", "AZUL", "VEGAS", "BURGUNDY", "CARCASSONNE", "CLUE", "TERRORSCAPE", "PANDEMIC", "PERCH", "HARMONIES", "PATCHWORK", "ARNAK", "TERRAFORMING_MARS", "SEVEN_WONDERS_DUEL"]);
