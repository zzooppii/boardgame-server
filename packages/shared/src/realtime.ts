import type { ArkNovaActCommand } from "./protocol.js";
...
import type { PandemicClientCommand } from "./protocol.js";
import type { PerchClientCommand } from "./protocol.js";
...
export interface SnapshotWireClientToServerEvents {
  ...
  "arkNova:act": (command: ArkNovaActCommand, acknowledge: SocketAcknowledgement<StateSyncWireAck>) => void;
