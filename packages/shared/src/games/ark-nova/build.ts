...
export const ArkBuildBonusSchema = v.strictObject({id:ArkRefSchema,kind:v.picklist(['MONEY_5','MONEY_10','X_1','CARD_1','REPUTATION_2','WORKER','UPGRADE','MONEY_2','REPUTATION_1','MOVE_1','KIOSK','PAID_SPONSOR','FREE_PARTNER','FREE_UNIVERSITY','MULTIPLIER'])});
