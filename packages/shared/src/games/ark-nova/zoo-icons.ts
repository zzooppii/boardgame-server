import {ARK_CARDS,type ArkCardDefinition} from './catalog.js';
import {ARK_CONTINENTS,type ArkCard} from './actions.js';
import { arkUniversityResearch } from './university-research.js';
