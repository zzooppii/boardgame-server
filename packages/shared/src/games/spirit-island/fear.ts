...
export const SPIRIT_BRANCH_FEAR = {
 reluctant:{name:'탐험가의 망설임',artwork:'SHADOW',effects:['다음 정상 탐험 카드가 일치하는 보드별 최저 번호 지역의 탐험을 생략합니다.','다음 정상 탐험은 카드 공개까지 생략합니다. 다음 침략자 단계에 탐험 카드 1장을 추가합니다.','다음 정상 탐험을 생략하되 카드는 공개합니다. 심화와 카드 이동은 정상 진행합니다.']},
 immigration:{name:'이주 둔화',artwork:'RIVER',effects:['다음 정상 건설 카드가 일치하는 보드별 최저 번호 지역의 건설을 생략합니다.','다음 정상 건설을 생략하고 해당 카드는 건설 칸에 남깁니다.','다음 정상 건설을 생략합니다. 카드는 정상 이동합니다.']},
 wildbeasts:{name:'야수에 질린 침략자',artwork:'FANGS',effects:['각자 야수가 있거나 인접한 지역의 침략자 하나에 분쟁 1개.','각자 야수가 있거나 인접한 지역의 침략자 하나에 분쟁 1개. 이번 라운드 야수 지역의 정상 건설·탐험을 생략합니다.','각자 야수가 있거나 인접한 지역의 침략자 하나에 분쟁 1개. 이번 라운드 야수 지역의 모든 정상 침략자 행동을 생략합니다.']},
 ...
 quarantine:{name:'격리',artwork:'KEEPER',effects:['이번 라운드 해안에서 탐험하지 않습니다.','이번 라운드 해안에서 탐험하지 않습니다. 질병 지역은 탐험 출발지가 아닙니다.','이번 라운드 해안에서 탐험하지 않습니다. 질병 지역의 파괴·건설·탐험을 생략합니다.']},
