...
export const TERROR_PLAN_STEP:Record<TerrorPlanStep,string>={KILLER:'살인마의 공개 위치',BOOK:'도서관 R5',TOOLS:'헛간 G3',OCCULT:'묘지 G2',RADIO:'무전기 B1',EXIT:'숨겨진 출구 G5',TOGETHER:'생존자 전원 같은 장소',APART:'생존자 모두 서로 다른 장소'};
export const TERROR_PLAN_INFO:Record<TerrorPlan,{name:string;steps:TerrorPlanStep[];description:string}>={
 ...
 SEAL:{name:'Strike Back! The Arcane Seal',steps:['OCCULT','KILLER','OCCULT','OCCULT'],description:'완료 즉시 묘지에 소음. 묘지에서 공격을 성공적으로 방어하면 생존자 승리.'},
 ...
 PORTAL:{name:'The Concealed Portal',steps:['EXIT','OCCULT','OCCULT','BOOK'],description:'차례 시작에 전원이 묘지에 있고 지도·손전등·부적을 가지고 있으면 승리.'},
 MOLOTOV:{name:'Molotov',steps:['TOOLS','TOOLS'],description:'매 공격에 위스키 한 개를 버려 방어 +2. 보통 방어 아이템과 함께 사용할 수 있습니다.'},
 SKELETON_KEY:{name:'Skeleton Key',steps:['TOOLS','TOOLS','BOOK','BOOK'],description:'일회용 기본 행동: 대현관에서 공구상자를 버려 수색 덱 맨 아래 열쇠를 획득.'},
 INTEL:{name:'Intel Sharing',steps:['APART','APART','TOGETHER'],description:'완료 즉시 선택한 생존자가 수색 카드 1장을 뽑습니다.'},
 MYSTIC_HERBS:{name:'Mystic Herbs',steps:['OCCULT','OCCULT'],description:'일회용 추가 행동: 묘지의 생존자를 치료하고 공포를 모두 제거.'},
