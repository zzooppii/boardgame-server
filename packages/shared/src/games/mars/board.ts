...
export const MARS_AWARDS = [{ id: 'landlord', name: '개척기업', detail: '화성 위 소유 타일 수' }, { id: 'banker', name: '금융기업', detail: 'M€ 생산량' }, { id: 'scientist', name: '과학기업', detail: '과학 태그 수' }, { id: 'thermalist', name: '열기업', detail: '열 보유량' }, { id: 'miner', name: '광업기업', detail: '강철 + 티타늄 보유량' }] as const;
