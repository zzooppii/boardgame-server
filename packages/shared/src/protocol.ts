...
import { CarcassonneActionSchema, CarcassonneSettingsSchema } from "./games/carcassonne/actions.js";
...
import { HarmoniesActionSchema, HarmoniesSettingsSchema, HarmoniesDraftSchema } from "./games/harmonies/actions.js";
import { PatchworkActionSchema, PatchworkSettingsSchema } from "./games/patchwork/actions.js";
...
const MarsIdentity = { protocolVersion: ProtocolVersionSchema, requestId: RequestIdSchema, gameId: GameIdSchema, expectedGameRevision: GameRevisionSchema };
...
export const MarsActCommandSchema = v.strictObject({ ...MarsIdentity, kind: v.literal("mars:act"), turnId: TurnIdSchema, payload: MarsActionSchema });
...
export const CarcassonneConfigureCommandSchema = v.strictObject({protocolVersion:ProtocolVersionSchema,requestId:RequestIdSchema,kind:v.literal("carcassonne:configure"),expectedRoomRevision:RoomRevisionSchema,payload:CarcassonneSettingsSchema});
export const CarcassonneClientCommandSchema = v.variant("kind",[CarcassonneActCommandSchema,CarcassonneConfigureCommandSchema]);
...
export const HarmoniesConfigureCommandSchema = v.strictObject({protocolVersion:ProtocolVersionSchema,requestId:RequestIdSchema,kind:v.literal('harmonies:configure'),expectedRoomRevision:RoomRevisionSchema,payload:HarmoniesSettingsSchema});
export const HarmoniesDraftCommandSchema = v.strictObject({...HarmoniesIdentity,kind:v.literal('harmonies:draft'),turnId:TurnIdSchema,payload:v.strictObject({steps:HarmoniesDraftSchema})});
export const HarmoniesClientCommandSchema = v.union([HarmoniesActCommandSchema,HarmoniesConfigureCommandSchema,HarmoniesDraftCommandSchema]);
export const PatchworkConfigureCommandSchema = v.strictObject({protocolVersion:ProtocolVersionSchema,requestId:RequestIdSchema,kind:v.literal('patchwork:configure'),expectedRoomRevision:RoomRevisionSchema,payload:PatchworkSettingsSchema});
export const PatchworkClientCommandSchema = v.variant('kind',[PatchworkActCommandSchema,PatchworkConfigureCommandSchema]);
export const ArnakClientCommandSchema = ArnakActCommandSchema;
export const MarsConfigureCommandSchema = v.strictObject({protocolVersion:ProtocolVersionSchema,requestId:RequestIdSchema,expectedRoomRevision:RoomRevisionSchema,kind:v.literal('mars:configure'),payload:v.strictObject({corporateEra:v.boolean(),prelude:v.optional(v.boolean())})});
export const MarsClientCommandSchema = v.variant('kind',[MarsActCommandSchema,MarsConfigureCommandSchema]);
...
export type MarsClientCommand = v.InferOutput<typeof MarsClientCommandSchema>;
